...
const Home = () => {
  ...
  return (
    <div>
      ...
      <SearchBar />
      <button onClick={toggleSortOrder} className="mb-4 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">
      ...
      <Pagination currentPage={currentPage} usersPerPage={usersPerPage} totalUsers={totalUsers} paginate={paginate} />
    </div>
  )
}
